...
export function AdminDashboardLayout({
  ...
  const items = [
    { href: "/admin/dashboard", label: t("dashboard"), icon: BarChart3 },
    { href: "/admin/users", label: t("users"), icon: User },
    { href: "/admin/plans", label: t("plans"), icon: Calendar },
    { href: "/admin/messages", label: t("messages"), icon: MessageCircle },
  ];
  return (
